  ...
  <nav class="base-nav-bar">
    <div class="container">
      ...
      <ul @mouseleave="hoverId=typeId">
        <li class="item" :class="{active: activeItem1}" @click="select(0)" @mouseenter="hoverId=0">
          <img v-show="activeItem1" src="@img/nav/all_selected.png" />
          <img v-show="!activeItem1" src="@img/nav/all_unselected.png" />
          <span>全部</span>
        </li>
        <li class="item" :class="{active: activeItem2}" @click="select(1)" @mouseenter="hoverId=1">
          <img v-show="activeItem2" src="@img/nav/football_selected.png" />
          <img v-show="!activeItem2" src="@img/nav/football_unselected.png" />
          <span>足球</span>
        </li>
        <li class="item" :class="{active: activeItem3}" @click="select(2)" @mouseenter="hoverId=2">
          <img v-show="activeItem3" src="@img/nav/basketball_selected.png" />
          <img v-show="!activeItem3" src="@img/nav/basketball_unselected.png" />
          <span>篮球</span>
        </li>
